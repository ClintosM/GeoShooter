...
bulletProperties = oPlayer.shootingModeSlots[oPlayer.currentMode]

//implementation 1
bulletColor = bulletProperties != undefined ? oPlayer.shootingModeSlots[oPlayer.currentMode].bulletColor : c_white
//implementation 2
